...
@switch($name)
    @case('search')
        ...
        @break
    @case('star')
        <svg class="icon" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
        @break
    @case('clock')
    ...
    @case('share')
        ...
        @break
    @case('bowl')
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11h18a1 1 0 0 1 .8 1.6C20 16.4 16.4 19 12 19s-8-2.6-10.8-6.4A1 1 0 0 1 2 11z"/><path d="M12 19v3"/><path d="M8 22h8"/></svg>
        @break
    @case('fish')
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 12c2-5.5 7-7.5 13.5-7.5-2 3.5-2 8.5 0 12-6.5 0-11.5-2-13.5-7.5z"/><path d="M2.5 15.5C4 14 4 10 2.5 8.5"/><circle cx="15" cy="12" r="1" fill="currentColor"/></svg>
        @break
    @case('salad')
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 13h18a1 1 0 0 1 .8 1.6C20 18 16.5 20 12 20s-8-2-9.8-5.4A1 1 0 0 1 3 13z"/><path d="M9 13c0-3 1.5-5 4-6.5"/><path d="M15 13c0-3.5-2-6-5-7"/><path d="M12 13V6"/></svg>
        @break
    @case('utensils')
        ...
        @break
    @case('sake')
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2h8l1 8H7z"/><path d="M7 10c0 4 2 7 5 7s5-3 5-7"/><path d="M12 17v4"/><path d="M8 21h8"/></svg>
        @break
    @case('leaf')
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.9C15.5 4.9 20 2 20 2s-1.5 5.5-3 10c-1.5 4.5-6 8-6 8z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 12 13"/></svg>
        @break
@endswitch
